 ...
 *
 */
public class MusicVectorSpaceModel {
	
	/**
	 * The corpus of documents.
	 */
	private MusicCorpus corpus;
	 ...
	 */
	private HashMap<MusicDocument, HashMap<String, Double>> tfIdfWeights;
	 ...
	 */
	public MusicVectorSpaceModel(MusicCorpus corpus) {
		this.corpus = corpus;
		tfIdfWeights = new HashMap<MusicDocument, HashMap<String, Double>>();
	...
	private void createTfIdfWeights() {
		...
		for (MusicDocument document : corpus.getDocuments()) {
	 ...
	 */
	private double getMagnitude(MusicDocument document) {
		double magnitude = 0;
	 ...
	 */
	private double getDotProduct(MusicDocument d1, MusicDocument d2) {
		double product = 0;
	 ...
	 */
	public double cosineSimilarity(MusicDocument d1, MusicDocument d2) {
